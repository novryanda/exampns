        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((feature) => (
            <article
              ...
              className={cn(
                landingTheme.card,
                "flex flex-col items-center p-8 text-center transition-shadow hover:shadow-md sm:p-10",
              )}
            >
              <div className="mb-6 flex h-40 w-full items-center justify-center sm:h-44 md:h-48">
                <Image
                  src={feature.icon}
                  alt=""
                  width={200}
