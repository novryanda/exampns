import { CalendarDays, Clock3, Crown, KeyRound, Lock, MailCheck, ShieldCheck, UserRound } from "lucide-react";
...
import { AccountSummaryRow } from "./_components/account-summary-row";
              ...
              <div className="border-t border-slate-100 pt-1">
                <dl className="space-y-5">
                  <AccountSummaryRow
                    ...
                    label="Status akun"
                    hint="Akun Anda aktif dan dapat digunakan."
                  >
