...
export const provisionTrialSubscriptionForUser = async (userId) => {
    ...
    if (!trialConfig || !trialPlan) {
        console.warn('[auth] skipped trial provisioning because active trial config or trial plan is missing');
        return;
    }
