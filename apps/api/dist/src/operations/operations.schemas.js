...
export const adminUsersQuerySchema = z.object({
    ...
    subscriptionStatus: z.preprocess(emptyToUndefined, z.enum(['active', 'expired', 'trial']).optional()),
...
export const updateSubscriptionPlanSchema = createSubscriptionPlanSchema.partial().refine((value) => Object.keys(value).length > 0, { message: 'At least one field is required' });
