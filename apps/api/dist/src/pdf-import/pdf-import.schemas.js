import { ImportBatchStatus, ParsedQuestionStatus, QuestionCategory, QuestionDifficulty, QuestionStatus, } from '../../generated/prisma/client.js';
import { z } from 'zod';
...
export const uploadPdfMetadataSchema = z.object({
    categoryHint: z.preprocess(emptyToUndefined, z.enum(['TWK', 'TIU', 'TKP', 'auto']).optional()),
});
...
//# sourceMappingURL=pdf-import.schemas.js.map