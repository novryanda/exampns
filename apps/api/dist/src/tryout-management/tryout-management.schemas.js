import { AccessType, ManualQuestionSetStatus, QuestionCategory, QuestionDifficulty, QuestionOrderMode, RandomizationMode, TryoutStatus, TryoutType, } from '../../generated/prisma/client.js';
import { z } from 'zod';
...
const jsonSchema = z.lazy(() => z.union([jsonLiteralSchema, z.array(jsonSchema), z.record(z.string(), jsonSchema)]));
...
//# sourceMappingURL=tryout-management.schemas.js.map