...
export default async function SuperAdminProfilePage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title="Profile" description="Informasi akun super admin yang sedang aktif." />
      <SectionCard title="Akun Super Admin" description="Akses penuh ke konfigurasi sistem.">
