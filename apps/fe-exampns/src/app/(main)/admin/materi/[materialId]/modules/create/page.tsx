  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: Record<string, unknown> = {
        ...
        videoUrl: moduleType === "video" ? videoUrl : undefined,
        pdfUrl: moduleType === "pdf" ? pdfUrl : undefined,
        durationMinutes: durationMinutes ? parseInt(durationMinutes, 10) : undefined,
        manualQuestions: moduleType === "quiz" ? questions : undefined,
      };

      const res = await fetch(
        `/api/admin-data/learning-materials/${materialId}/modules`,
        {
          method: "POST",
      ...
      if (!res.ok) {
        ...
        throw new Error(body.message ?? "Gagal menyimpan modul");
      }
    ...
    <div className="pb-10">
      ...
      <div className="mx-auto max-w-4xl px-6">
        <form id="module-create-form" onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          {/* Konten teks (text = required, video = opsional notes) */}
