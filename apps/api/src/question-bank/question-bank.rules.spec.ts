...
describe('QuestionBank rules', () => {
  it('accepts TWK options with exactly one correct answer', () => {
    expect(() =>
      assertQuestionOptionRules('single_correct', [
  ...
  it('rejects TKP options without tkpWeight', () => {
    expect(() =>
      assertQuestionOptionRules('weighted_options', [
        { label: 'A', text: 'A', optionWeight: 5 },
        { label: 'B', text: 'B', optionWeight: 4 },
        { label: 'C', text: 'C', optionWeight: 3 },
        { label: 'D', text: 'D', optionWeight: 2 },
        { label: 'E', text: 'E' },
      ]),
